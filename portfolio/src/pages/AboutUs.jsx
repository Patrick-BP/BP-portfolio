...
function AboutUs() {
  ...
  <div class="grid-rows">
    ...
    <div class="grid-row">
      ...
      <div class="skill-card" title="React">
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <ellipse cx="12" cy="12" rx="10" ry="3.8" stroke="#c8bfe8" stroke-width="1.3" fill="none"/>
          <ellipse cx="12" cy="12" rx="10" ry="3.8" stroke="#c8bfe8" stroke-width="1.3" fill="none" transform="rotate(60 12 12)"/>
          <ellipse cx="12" cy="12" rx="10" ry="3.8" stroke="#c8bfe8" stroke-width="1.3" fill="none" transform="rotate(120 12 12)"/>
        </svg>
        <span class="skill-label">React</span>
      </div>

      {/* <!-- Angular --> */}
      <div class="skill-card" title="Angular">
    ...
    <div class="grid-row">
      ...
      {/* <!-- Express.js --> */}
      <div class="skill-card" title="Express.js">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#c8bfe8">
      ...
      {/* <!-- SQL --> */}
      <div class="skill-card" title="SQL">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#c8bfe8">
      ...
      {/* <!-- MongoDB --> */}
      <div class="skill-card" title="MongoDB">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#c8bfe8">
      ...
      {/* <!-- Spring Boot --> */}
      <div class="skill-card" title="Spring Boot">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#c8bfe8">
      ...
      <section className="story">
        <h1 className="banner-content__title">My Coding Journey</h1>
